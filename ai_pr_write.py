...
# Define the label name to be used
AUTO_PR_BODY_LABEL = "auto-pr-body"
...
def main():
    ...
    if any(label.name.lower() == AUTO_PR_BODY_LABEL.lower() for label in pr.get_labels()):
        print(
            f"PR #{pr_number} already has the label '{AUTO_PR_BODY_LABEL}'. Skipping PR body generation.")
    ...
    repo = pr.base.repo
    try:
        label = repo.get_label(AUTO_PR_BODY_LABEL)
    except UnknownObjectException:
        # Label does not exist; create it with a default color
        label = repo.create_label(
            name=AUTO_PR_BODY_LABEL, color="f29513", description="PR body auto-generated by AI.")
